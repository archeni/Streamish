...
namespace Streamish.Repositories
{
    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
            ...
            using (var conn = Connection)
            {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @"
                      ...
                      c.Id as CommentId, c.Message, c.VideoId, c.UserProfileId AS UserProfileCommentId
                    ...
                    while (reader.Read())
                    {
                        ...
                        if (DbUtils.IsNotDbNull(reader, "CommentId"))
                        {
                            video.Comments.Add(new Comment()
                            {
                                ...
                                VideoId = id,
                                UserProfileId = DbUtils.GetInt(reader, "UserProfileCommentId")
                            });
                        }
                    }
        ...
        public List<Video> SearchDate(DateTime date)
        {
            using (var conn = Connection)
            {
                conn.Open();
